...
def inject_global_data():
    ...
    return {
        ...
        'get_room_image': lambda img: url_for('static', filename=img) 
                          if img and not img.startswith('http') else (img or "https://images.unsplash.com/photo-1522771739844-649f6d175d97")
    }
...
def add_security_headers(response):
    ...
    csp = (
        "default-src 'self'; "
        "script-src 'self' https://cdn.jsdelivr.net https://kit.fontawesome.com https://cdnjs.cloudflare.com 'unsafe-inline'; "
